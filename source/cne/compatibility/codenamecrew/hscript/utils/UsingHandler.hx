package cne.compatibility.codenamecrew.hscript.utils;
...
class UsingHandler { 
	...
	@:allow(cne.compatibility.codenamecrew.hscript.CustomClass)
	@:allow(cne.compatibility.codenamecrew.hscript.CustomClassHandler)
