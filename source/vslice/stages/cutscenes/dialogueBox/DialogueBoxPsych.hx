package vslice.stages.cutscenes.dialogueBox;

#if !LEGACY_PSYCH
import substates.PauseSubState;
#end
import vslice.stages.cutscenes.dialogueBox.styles.*;
import vslice.stages.cutscenes.dialogueBox.styles.DialogueStyle;
import vslice.stages.cutscenes.dialogueBox.styles.DialogueStyle.DialogueBoxState;
import vslice.stages.cutscenes.dialogueBox.styles.DialogueStyle.DialogueBoxPosition;
