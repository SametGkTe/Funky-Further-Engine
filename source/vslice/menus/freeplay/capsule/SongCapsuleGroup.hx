package vslice.menus.freeplay.capsule;

import vslice.menus.freeplay.capsule.SongMenuItem.SongCapsuleAnim;
import vslice.menus.freeplay.capsule.CustomAnimControl;
...
class SongCapsuleGroup extends FlxTypedGroup<SongMenuItem> {
    ...
    @:allow(vslice.menus.freeplay.capsule.CapsuleNumber)
