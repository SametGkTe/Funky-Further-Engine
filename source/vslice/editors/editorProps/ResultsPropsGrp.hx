package vslice.editors.editorProps;

import vslice.compatibility.funkin.FunkinPath;
import vslice.editors.editorProps.sprites.IResultsSprite;
import vslice.editors.editorProps.sprites.ResultsAtlasSprite;
import vslice.editors.editorProps.sprites.ResultsStaticSprite;
import vslice.editors.editorProps.sprites.ResultsSparrowSprite;
import haxe.Exception;
import flixel.util.FlxSort;
import vslice.funkin.players.PlayerData.PlayerResultsAnimationData;
