...
/**
 * Shared Freeplay song list + disk cache + grouping.
 * Cache file: FreeplaySongList.json (next to modsList.txt).
 */
class FreeplayCatalog
{
	...
	public static function buildRows(items:Array<FreeplayRowSource>, search:String):Array<FreeplayListRow>
	{
		...
		for (cat in groups)
		{
			...
			// Searching: keep matching songs visible even if the group was collapsed.
