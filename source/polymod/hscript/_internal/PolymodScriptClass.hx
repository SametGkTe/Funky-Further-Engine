...
class PolymodScriptClass
{
   ...
   * (Further: vendored patch - public hale getirildi, VSScriptRegistry kullanir.)
   */
  public static function registerScriptClassByString(body:String, ?path:String):Void
  {
   ...
   * (Further: vendored patch - public hale getirildi.)
   */
